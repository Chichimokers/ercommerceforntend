      ...
      >
        {comments.map((comment) => (
          <SwiperSlide key={comment.id}>
            <div className="bg-slate-300 bg-opacity-40 dark:bg-gray-700 dark:bg-opacity-40 p-4 rounded-xl shadow m-4 h-[180px] lg:h-[220px] xxs:h-[200px] xs:h-[250px] xl:h-[180px] 2xl:h-[180px]">
