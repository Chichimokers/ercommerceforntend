...
export default function EmptyState({
  ...
  return (
    <div
      className={`flex flex-col items-center justify-center p-8 space-y-4 bg-default-50/50 border rounded-xl ${className}`}
    >
      <div className="relative group">
        <div className="absolute -inset-2 bg-blue-400/30 rounded-full opacity-70 group-hover:opacity-100 transition-opacity duration-300 animate-[pulse_2s_infinite]" />
        <AlertCircle
          size={iconSize}
