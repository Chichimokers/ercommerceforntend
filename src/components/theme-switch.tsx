  ...
  return (
    ...
    >
      <Component
        ...
        {...getBaseProps({
          className: clsx(
            "px-px flex flex-col items-center justify-center border-2 border-default-200 h-10 w-10 rounded-full hover:border-default-400 cursor-pointer bg-opacity-50 dark:bg-opacity-50",
            className,
            classNames?.base
          ),
        })}
