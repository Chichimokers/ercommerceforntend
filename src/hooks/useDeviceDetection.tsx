...
/**
 * Interfaz que define la información del dispositivo
 */
export interface DeviceInfo {
  ...
  isDataSaver: boolean;
  screenSize: 'small' | 'medium' | 'large' | 'desktop';
}
...
export function useDeviceDetection(): DeviceInfo {
  ...
  useEffect(() => {
    ...
    const checkCapabilities = () => {
      ...
      let effectiveType: DeviceInfo['effectiveType'] = '4g';
      ...
      if ('connection' in navigator) {
        ...
        // Asegurar que effectiveType es uno de los valores válidos
        if (conn?.effectiveType && ['slow-2g', '2g', '3g', '4g'].includes(conn.effectiveType)) {
          effectiveType = conn.effectiveType as DeviceInfo['effectiveType'];
        }
